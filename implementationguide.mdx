...
| [Signup Form ](https://ui.fractalpay.com/PayWidget)                  | Merchants will be boarded via an online signup form.                                                                         |
| [Full API Boarding](https://docs.fractalpay.com/api-reference/endpoint/Merchant%20Submit)            | The Full Boarding API is a managed service allowing you complete flexibility in the creation of new merchant locations.       |
...
| [Onboarding Webhooks](https://docs.fractalpay.com/Webhooks#merchant-onboarding)          | The Full Boarding API is a managed service allowing you complete flexibility in the creation of new merchant locations.       |
...
| Wallet - TBD                     | Provides merchants with a collection of card-on-file and billing-on-file solutions via API.                                    |
