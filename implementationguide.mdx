...
| Question                                        | Note                                                                                       |
| ----------------------------------------------- | ------------------------------------------------------------------------------------------ |
| Describe your current application and what it does: | **For example:**  - A B2B system facilitating payments for customers with regular fees?  - An eCommerce site with a shopping cart using WordPress or similar? |
