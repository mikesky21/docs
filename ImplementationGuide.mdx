...
![Fractal Payment Workflow](https://example.com/path/to/your/image.png)
...
| Signup Forms                  | Merchants will be boarded via an online signup form.             |
...
| Bulk-boarding                 | Fractal will work with you to meet the necessary technical and underwriting requirements for bulk onboarding, simplifying the process of migrating your existing Merchants to Fractal from another platform. |
